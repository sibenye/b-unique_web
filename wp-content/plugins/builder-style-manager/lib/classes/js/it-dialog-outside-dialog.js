...
( function( $ ) {
	it_dialog = {
		...
		load_window: function() {
			...
			markup += '<iframe id="it-dialog-iframe" frameborder="0" hspace="0" src="' + this.url + '" name="' + this.iframe_name + '" onload="it_dialog.handle_iframe_load()">' + it_dialog_vars.no_iframes_message + '</iframe>';
			markup += '</div>';
