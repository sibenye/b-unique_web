...
Version History
	1.0.0 - 2011-05-16 - Chris Jean
		Removed the WordPress admin bar in the preview
		Updated to use BuilderStyleManagerGenerator as an instanced class
	1.0.1 - 2011-06-29 - Chris Jean
		Fixed an issue with calling generate_stylesheet on $this rather than $generator
	1.0.2 - 2011-10-20 - Chris Jean
		Fixed stylesheet URL for sites that can be selectively loaded as https
...
class BuilderStyleManagerPublic {
	...
	function handle_preview() {
		...
		$css_url = ITFileUtility::get_url_from_file( dirname( __FILE__ ) . '/css/normalize-styling.css' );
